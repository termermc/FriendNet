...
export type GetDownloadManagerItemsResponse = Message<"pb.clientrpc.v1.GetDownloadManagerItemsResponse"> & {
   ...
   *
   * @generated from field: optional pb.clientrpc.v1.DownloadManagerItem items = 1;
   */
