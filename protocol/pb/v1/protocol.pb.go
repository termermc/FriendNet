...
const (
	...
	// The server may return CONN_RESULT_DID_NOT_TRY for IP addresses it refuses to connect to, such as LAN addresses.
	...
	// [S2C, C2C] Submits a search query.
	// If C2C, the client is expected to return search results in its shares and return the results.
	// If C2C, the server will stream results from clients as they come in.
	// Expected: Either:
...
const file_pb_v1_protocol_proto_rawDesc = "" +
	...
	"\taddresses\x18\x01 \x03(\tR\taddresses*\xb3\v\n" +
	"\aMsgType\x12\x18\n" +
...
var file_pb_v1_protocol_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
